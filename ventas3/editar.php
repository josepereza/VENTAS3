...
<?php include_once "encabezado.php" ?>
	<div class="col s12">
		...
		<form method="post" action="guardarDatosEditados.php">
			...
			<input value="<?php echo $producto->codigo ?>" class="validate" name="codigo" required type="text" id="codigo">
			<label for="codigo">Código de barras:</label>
			</div>
			</div>

			<label for="descripcion">Descripción:</label>
			<input value="<?php echo $producto->descripcion ?>"required id="descripcion" name="descripcion"  class="validate">
